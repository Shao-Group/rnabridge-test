summarize.3 = function(datafile, outputfile)
{
	...
	result[2 * 2 - 1] = mean(data[,5]);
	result[3 * 2 - 1] = mean(data[,9]);
	result[4 * 2 - 1] = mean(data[,15]);
	result[5 * 2 - 1] = mean(data[,7]);
	result[6 * 2 - 1] = mean(data[,11]);
	result[7 * 2 - 1] = mean(data[,19]);
	result[8 * 2 - 1] = mean(data[,17]);
	result[9 * 2 - 1] = mean(data[,18]);
	result[10* 2 - 1] = mean(data[,23]);
	result[11* 2 - 1] = mean(data[,21]);
	result[12* 2 - 1] = mean(data[,22]);

	result[1 * 2 - 0] = sd(data[,13]);
	result[2 * 2 - 0] = sd(data[,5]);
	result[3 * 2 - 0] = sd(data[,9]);
	result[4 * 2 - 0] = sd(data[,15]);
	result[5 * 2 - 0] = sd(data[,7]);
	result[6 * 2 - 0] = sd(data[,11]);
	result[7 * 2 - 0] = sd(data[,19]);
	result[8 * 2 - 0] = sd(data[,17]);
	result[9 * 2 - 0] = sd(data[,18]);
	result[10* 2 - 0] = sd(data[,23]);
	result[11* 2 - 0] = sd(data[,21]);
	result[12* 2 - 0] = sd(data[,22]);
